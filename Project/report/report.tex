...
The figure of the performance of this situation is shown in "Figure 8", comparing to the performance of the one with ten users.
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{4_4.eps}
\caption{n-p Graph for Sample 8}
\end{figure}
...
The figure of the performance of this situation is shown in "Figure 9", including the theoretic value at this situation.
\begin{figure}
\centering
